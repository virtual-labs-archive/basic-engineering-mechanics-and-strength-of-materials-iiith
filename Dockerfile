...
RUN mkdir /basic-engineering-mechanics-and-strength-of-materials-iiith

COPY src/ /basic-engineering-mechanics-and-strength-of-materials-iiith/src

WORKDIR ./basic-engineering-mechanics-and-strength-of-materials-iiith/src
